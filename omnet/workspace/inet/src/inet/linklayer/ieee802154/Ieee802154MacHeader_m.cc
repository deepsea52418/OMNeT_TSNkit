...
Ieee802154MacHeader::Ieee802154MacHeader() : ::inet::MacHeaderBase()
{
}

Ieee802154MacHeader::Ieee802154MacHeader(const Ieee802154MacHeader& other) : ::inet::MacHeaderBase(other)
{
    copy(other);
}
...
Ieee802154MacHeaderDescriptor::Ieee802154MacHeaderDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(inet::Ieee802154MacHeader)), "inet::MacHeaderBase")
{
