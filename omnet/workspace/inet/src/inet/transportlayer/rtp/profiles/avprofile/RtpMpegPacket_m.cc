...
int RtpMpegHeader::getPictureType() const
{
    return this->pictureType;
}

void RtpMpegHeader::setPictureType(int pictureType)
{
    handleChange();
...
std::string RtpMpegHeaderDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_pictureType: return long2string(pp->getPictureType());
        default: return "";
    }
}
...
bool RtpMpegHeaderDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case FIELD_pictureType: pp->setPictureType(string2long(value)); return true;
