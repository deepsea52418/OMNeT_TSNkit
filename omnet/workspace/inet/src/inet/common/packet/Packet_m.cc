//
// Generated file, do not edit! Created by nedtool 5.6 from inet/common/packet/Packet.msg.
//
...
int PacketDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0] == 't' && strcmp(fieldName, "totalLength") == 0) return base+0;
    if (fieldName[0] == 'd' && strcmp(fieldName, "dataLength") == 0) return base+1;
    if (fieldName[0] == 'f' && strcmp(fieldName, "frontOffset") == 0) return base+2;
    if (fieldName[0] == 'b' && strcmp(fieldName, "backOffset") == 0) return base+3;
